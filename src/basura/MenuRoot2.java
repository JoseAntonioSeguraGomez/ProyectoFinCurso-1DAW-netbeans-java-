...
public class MenuRoot2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuRoot2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
